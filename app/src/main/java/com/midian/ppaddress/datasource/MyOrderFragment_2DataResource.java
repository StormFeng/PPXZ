 ...
 */
public class MyOrderFragment_2DataResource extends BaseListDataSource {

    private String type="2",pageNo="1",pageSize="10";//type的取值是1或2,1代表已签约,2代表已完成
    public MyOrderFragment_2DataResource(Context context) {
        super(context);
    }
