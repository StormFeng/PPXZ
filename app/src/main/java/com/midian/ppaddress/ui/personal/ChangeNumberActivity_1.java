 ...
 */
public class ChangeNumberActivity_1 extends BaseActivity implements View.OnClickListener{
    private BaseLibTopbarView topbar;
    private EditText et_Number,et_CheckCode;
    private Button btn_Next,btn_CheckCode;
    private LinearLayout ll_phone,ll_checkcode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_changenumber_1);
        initView();
    }
    ...
    public void onApiSuccess(NetResult res, String tag) {
        ...
        if (res.isOK()) {
            ...
            if ("validateCode".equals(tag)) {
                ...
                UIHelper.jump(_activity,ChangeNumberActivity_2.class,mBundle);
                finish();
            }
        } else {
    ...
    private void initView() {
        ...
        et_Number.setText(ac.getProperty("phone"));
    }
    ...
    public void onClick(View arg0) {
        ...
        type=3;//必填；1:注册, 2:忘记密码, 3:更换手机, 4:修改密码, 5:更改支付信息
