...
public class GuideActivity extends BaseActivity {
    ...
    private int[] mViewPagerData = new int[]{R.drawable.guide_1,
    ...
    private class CustomPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            ImageView entryBtn = (ImageView) itemView.findViewById(R.id.entryBtn);

            entryBtn.setTag(position);
            entryBtn.setOnClickListener(onClickListener);
            entryBtn.setImageResource(R.drawable.bg_guide_btn);
