 ...
 */
public class Detail5Fragment extends BaseFragment implements ApiCallback {

    private String carrierid;
    private ListViewForScrollView listView5;
    private Detail5Adapter detail5Adapter;
    private TextView wait_tv, empty_tv;
    private List<BusinessCarrierCommentsPageCounselorsBean.CommentList> dataList = new ArrayList<>();


    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_detail5, null);
        listView5 = (ListViewForScrollView) v.findViewById(R.id.listView5);
        wait_tv = (TextView) v.findViewById(R.id.wait_tv);
        empty_tv = (TextView) v.findViewById(R.id.empty_tv);
        detail5Adapter = new Detail5Adapter();
        listView5.setAdapter(detail5Adapter);
        loadData();
        return v;
    }

    private void loadData() {
        AppUtil.getPpApiClient(ac).businessCarrierCommentsPageCounselors(carrierid, "1", "10", this);
    }
    ...
    public void onApiSuccess(NetResult res, String tag) {
        ...
        if (res.isOK()) {
            BusinessCarrierCommentsPageCounselorsBean bean = (BusinessCarrierCommentsPageCounselorsBean) res;
            dataList = bean.getData().getList();
            if (dataList != null && dataList.size() > 0) {
                detail5Adapter.notifyDataSetChanged();
    ...
    class Detail5Adapter extends BaseAdapter {
        ...
        public View getView(final int position, View view, ViewGroup viewGroup) {
            ...
            //渲染数据
            final BusinessCarrierCommentsPageCounselorsBean.CommentList bean = dataList.get(position);
            ...
            holder.zan_ll.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if ("0".equals(ac.getProperty("user_type"))) {
                        Log.d("=-=--=-=", "getView: 渲染时的like_count="+ finalHolder.like_count+"likeType="+ finalHolder.likeType+"点击的位置position="+position);
