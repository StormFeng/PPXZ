 ...
 */
public class MemberSessageShowSysMessagesBean extends NetResult {
    public static MemberSessageShowSysMessagesBean parse(String json) throws AppException {
        MemberSessageShowSysMessagesBean res = new MemberSessageShowSysMessagesBean();
        try {
            res = gson.fromJson(json, MemberSessageShowSysMessagesBean.class);
    ...
    public class Data extends NetResult {
        private String lasePage;//true
        private String paseSize;//15
        private String pageNumber;//1
        private String firstPage;//true
        private List<CarrierList> carrierLists;
        private String totalRow;//1
        private String totalPage;//1

        public String getLasePage() {
            return lasePage;
        }

        public void setLasePage(String lasePage) {
        ...
        public List<CarrierList> getCarrierLists() {
            return carrierLists;
        }

        public void setCarrierLists(List<CarrierList> carrierLists) {
            this.carrierLists = carrierLists;
        }
