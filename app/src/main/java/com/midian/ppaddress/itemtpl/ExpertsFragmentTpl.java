 ...
 */
public class ExpertsFragmentTpl extends BaseTpl<CommentList> implements View.OnClickListener, ApiCallback {
    ...
    public ExpertsFragmentTpl(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ExpertsFragmentTpl(Context context) {
        super(context);
    }
    ...
    protected int getLayoutId() {
        return R.layout.item_experts_fragment_tpl;
    }
