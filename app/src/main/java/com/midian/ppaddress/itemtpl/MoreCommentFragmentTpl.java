 ...
 */
public class MoreCommentFragmentTpl extends BaseTpl<CommentMembersList> {

    private TextView name_tv, time_tv, content_tv, state_tv;
    private CircleImageView head_cv;

    public MoreCommentFragmentTpl(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MoreCommentFragmentTpl(Context context) {
        super(context);
    }
    ...
    public void setBean(CommentMembersList bean, int position) {
        ...
        if ("0".equals(rate)) {
            ...
            state_tv.setText("好评");
            state_tv.setBackgroundResource(R.color.my_appraise);
        } else if ("2".equals(rate)) {
            state_tv.setText("中评");
            state_tv.setBackgroundResource(R.color.comment_bg2);
        } else if ("3".equals(rate)) {
            state_tv.setText("差评");
            state_tv.setBackgroundResource(R.color.comment_bg3);
        }
    }
}
