 ...
 */
public class MoreWuyeCommentTpl extends BaseTpl<CommentList> implements View.OnClickListener, ApiCallback {
    ...
    public MoreWuyeCommentTpl(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MoreWuyeCommentTpl(Context context) {
        super(context);
    }
    ...
    protected int getLayoutId() {
        return R.layout.item_more_comment_tpl;
    }
