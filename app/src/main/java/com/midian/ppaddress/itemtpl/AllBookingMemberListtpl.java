...
public class AllBookingMemberListtpl extends BaseTpl<MemberOrderMemberPageBean.Lists> implements View.OnClickListener{
    ...
    public AllBookingMemberListtpl(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    public AllBookingMemberListtpl(Context context) {
        super(context);
    }
    @Override
    ...
    @Override
    public void setBean(MemberOrderMemberPageBean.Lists bean, int position) {
        if(bean!=null){
