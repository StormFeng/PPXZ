 ...
 */
public class ContrastTpl extends BaseTpl<CompareData> implements View.OnClickListener {
    ...
    public ContrastTpl(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ContrastTpl(Context context) {
        super(context);
    }
...
//        check_cb.setOnClickListener(this);
    ...
    public static void setIsEditable(boolean isEditable) {
        ContrastTpl.isEditable = isEditable;
    }
