...
import com.midian.ppaddress.bean.BusinessCarrierCommentsPageCounselorsBean.CommentList;
 ...
 */
public class DetailWuyeCommentFragmentTpl extends BaseTpl<CommentList> implements View.OnClickListener, ApiCallback {
    ...
    public DetailWuyeCommentFragmentTpl(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DetailWuyeCommentFragmentTpl(Context context) {
        super(context);
    }
    ...
    protected int getLayoutId() {
        return R.layout.item_comment_fragment_tpl;
    }
