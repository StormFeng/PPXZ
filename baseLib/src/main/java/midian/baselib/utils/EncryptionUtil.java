...
public class EncryptionUtil {
	...
	private final static String key = "lvMidian";
	// 向量A_iAS5d583PiR3kt2UQA
	private final static String iv = "01234567";

	public static String getEncryptionStr() {
		String ressult = encryptString(System.currentTimeMillis() +"_android");
...
//						sKey);
				// base64编码
				result = Base64.encodeToString(str.getBytes(encoding), Base64.DEFAULT);
			} catch (Exception e) {
				e.printStackTrace();
				return "-1";
			}
